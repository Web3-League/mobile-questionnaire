...
public class Volontaire implements java.io.Serializable {
	...
	// Relation vers toutes les études auxquelles ce volontaire participe
	@OneToMany(mappedBy = "id.idVolontaire", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
	private List<EtudeVolontaire> etudesParticipees = new ArrayList<>();
	...
	public List<EtudeVolontaire> getEtudesParticipees() {
		return etudesParticipees;
	}

	public void setEtudesParticipees(List<EtudeVolontaire> etudesParticipees) {
		this.etudesParticipees = etudesParticipees;
	}
